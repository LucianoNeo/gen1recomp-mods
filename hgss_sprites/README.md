...
Version 0.4.2 includes the 0.4.1 package plus normal, sparkle-free legendary
...
3. Download the [`HGSS_SPRITES` 0.4.2 asset](https://github.com/LucianoNeo/gen1recomp-mods/releases/tag/v0.4.2).
