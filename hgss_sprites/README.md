...
![Version](https://img.shields.io/badge/version-0.4.5-gold)
...
Version 0.4.5 includes the 0.4.4 package plus the Oak Pikachu-catch crash fix,
...
3. Download the [`HGSS_SPRITES` 0.4.5 asset](https://github.com/LucianoNeo/gen1recomp-mods/releases/tag/v0.4.5).
