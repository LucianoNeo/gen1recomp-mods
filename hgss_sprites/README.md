...
![Version](https://img.shields.io/badge/version-0.5.3-gold)
...
Version 0.5.3 fixes the evolution movie so both forms use the selected
...
3. Download the [`HGSS_SPRITES` 0.5.3 asset](https://github.com/LucianoNeo/gen1recomp-mods/releases/tag/v0.5.3).
