...
Version 0.3.2 includes the 0.3.1 features plus the verified map-object and
...
3. Download the [`HGSS_SPRITES` 0.3.2 asset](https://github.com/LucianoNeo/gen1recomp-mods/releases/tag/v0.3.2).
