...
![Version](https://img.shields.io/badge/version-0.5.4-gold)
...
objects were verified with Battle Art Voxel Fork 1.9.0. Version 0.5.3 fixes
the evolution movie so both forms use the selected
bundled front-generation artwork, with animated atlases cropped to one native
frame, and makes the party cursor navigate the two-column layout in all four
directions. Version 0.5.2 restores dedicated full-color Electrode and Voltorb map-object
...
glyph weight. Version 0.5.0 includes the 0.4.5 package plus current g1recomp sandbox loading
...
3. Download the [`HGSS_SPRITES` 0.5.4 asset](https://github.com/LucianoNeo/gen1recomp-mods/releases/tag/v0.5.4).
